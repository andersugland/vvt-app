...
<section class="container px-4 grid lg:grid-cols-12 lg:gap-5 py-sm">
...
<style lang="postcss">
	...
	:global(.content h1, .content h2, .content h3, .content h4, .content h5) {
		@apply mb-6;
	}

	:global(.content h1, .content h2) {
		@apply mb-8;
	}
